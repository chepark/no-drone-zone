...
class Drone {
  constructor(serialNumber, xCoordinate, yCoordinate) {
    ...
    this.distance = __classPrivateFieldGet(
      this,
      _Drone_instances,
      "m",
      _Drone_calculateDistance
    ).call(this, this.positionX, this.positionY);
    this.violatedNDZ = __classPrivateFieldGet(
      this,
      _Drone_instances,
      "m",
      _Drone_checkViolation
    ).call(this, this.distance);
  }
}
(_Drone_instances = new WeakSet()),
  (_Drone_calculateDistance = function _Drone_calculateDistance(
    xPosition,
    yPosition
  ) {
